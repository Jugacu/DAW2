...
<div id="content">
    ...
    if (isset($pizzaResult)) {
        ...
        <form method="post" action="/">
            ...
            <label for="tlf">Telefono<span>*</span></label>
            <input required type="tel" name="tlf" id="tlf" value="<?= $_SESSION['userData']['tlf'] ?>">

            <label for="mail">Correo<span>*</span></label>
            ...
            <div id="pizzas">
                ...
                for ($i = 1; $i <= $_SESSION['numberOfPizzas']; $i++) {
                    ?>
                    <div class="pizza">
                        <label for="pizza-<?= $i ?>">Elige<span>*</span></label>
                        ...
                        <label for="pizza-<?= $i ?>-type">Tamaño<span>*</span></label>
